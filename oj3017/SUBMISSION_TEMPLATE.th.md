...
```text
โจทย์ให้หาผลรวมที่ลูกค้าต้องชำระหลังจากได้รวมค่าบริการและ Vat โดนที่ถ้าหากค่าบริการต่ำกว่า 50 จะโดนคิดทันที 50 บาท แต่ถ้าหากมากกว่า 1000 จะคิดเต็มสูงสุดอยู่ที่ 1000 ส่วน Vat คือคิดหลังจากที่เราคิดค่าบริการแล้วเรียบร้อยถึงจะรวมทุกค่าออกมาให้ลูกค้าจ่ายได้
```
...
```text
Step 1:ทำการเขียนรับค่าราคาน้ำอาหารที่รวมกันมาแล้วใช้ float(input())
Step 2:ทำการตั้งอีกตัวแปรนึงขึ้นมาเป็นตัวแปรในการหาค่าบริการ(service_charge)
Step 3:หลังจากนั้นให้ทำ if else condition ในการเช็คค่า service_charge ถ้าน้อยกว่า 50 ให้คิด 50 ทันที แต่ถ้าหากมากกว่า 1000 ให้คิดมากสุดคือ 1000
Step 4:ให้หา Vat หลังจากที่คิดค่าอาหารรวมกับ service_charge แล้ว
Step 5:ให้ทำการรวมค่าทั้งหมด คือ ค่าอาหาร + service_charge + Vat
Step 6:print output ออกมาโดยที่ Output เปHo ทศนิยม 2 ตำแหน่ง
```
...
```text
เหมือกัน เพราะ วางแผนมาได้ถูกต้องและไม่มีอะไรติดขัดแล้วครับ
```
...
```text
เพราพว่าอยากลองทดสอบว่า service_charge ต่ำกว่า 50 แล้วจะรันถูกไหมครับ
```
...
```text
อยากลองเทสว่าถ้าหาก service_charge มากกว่า 1000 จะเป็นยังไง
```
