...
```text
โจทย์ให้ผมรับค่าเดือนและวันออกมาแล้วรันคำนวณฤดูกาลออกมาตามเดือนและวันที่กำหนด
...
Output:
ฤดูการตามที่ condition กำหนดมา

Constraints:
เรารับค่าเดือนและวันออกมาแล้วมาตรวจเช็ค conditions
```
...
```text
Step 1: เขียนรับค่า เดือน และ วัน ออกมา
Step 2: สร้าง if ออกมาถ้าเดือนนั้นเท่ากับ 1,2,3
Step 3: ทำการเขียน if ซ้อน if อีกว่า ถ้า กรณีที่เดือนนั้นเป็นเดือนสุดท้ายของฤดูกาลและถ้าหากวันดันเป็นวันที่ 21 ของเดือนสุดท้าย ให้ทำการเปลี่ยนฤดูกาลเป็นฤดูกาลถัดไปทันทีถ้าหากวันยังไ่ม่เกิน 21 ให้ฤดูกาลยังเหมือนเดิมตามเดือนที่กำหนด
Step 4: ทำการเขียนซ้ำโดยเรียงเดือน (3,4,5),(6,7,8) ไปเรื่อยๆจนครบ 12 เดือนตามที่โจทย์กำหนดมา
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรกครับผม
```
...
```text
ลองเช็คว่าเดือน 12 ค่าจะออกมาเป็นอะไร
```
...
```text
ลองเช็คว่าถ้าหากเป็นเดือนสุดท้ายของแต่ละฤดูจะเปลี่ยนไหม
```
...
```text
ลองทดสอบถ้าหากเป็นวันที่ 0 ค่าจะออกไหม
```
